...
use App\Models\Bowling\Combo;
use App\Models\Bowling\ComboMember;
use App\Models\Bowling\ComboValidation;
use App\Models\Bowling\Link;
use App\Models\Bowling\Promotions;
...
class BowlingController extends Controller
{
    ...
    {
        $data['title'] = "Bowling - Promociones";
        return view('bowling.promotions', $data);
    }
    ...
    {
        $data['title'] = "Bowling - Lista de Cortesías";
    ...
    {
        $data['title'] = "Bowling - Crear Promoción";
        $data['promotions']  = Promotions::where('status', 1)->get();
        return view('bowling.create', $data);
    }
    ...
    public function downloadQrCode($code)
    {
        ...
        $builderEntrada = new Builder(
            ...
            logoPath: public_path('img/bowling.png'),
    ...
    private function formatLinkData($link)
    {
        ...
        return [
            ...
            'date_issue' => $link->activate_date
                ? Carbon::parse($link->activate_date)->format('d/m/Y h:i A')
