                ...
                <div class="card">
                    <form id="paymentLinkForm">
                        <div
                            ...
                            <h5 class="card-title mb-sm-0 me-2">Formulario Pase de Cortesía FDT</h5>
                            ...
                            <div class="row">
                                <div class="col-lg-9 mx-auto">
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-floating form-floating-outline">
                                                <select id="audience" name="audience" class="select2 form-select"
                                                    data-allow-clear="true" data-placeholder="Seleccione Tipo Audiencia">
                                                    <option value="">Seleccione</option>
                                                    <option value="publico_general">Publico General</option>
                                                    <option value="influencer">Influencer</option>
                                                </select>
                                                <label for="document">Tipo Audiencia</label>
                                            </div>
                                        </div>
...
@section('scripts')
    ...
    <script src="{{ asset('js/add-courtesy-fdt.js') }}?v={{ time() }}"></script>
    <script>
