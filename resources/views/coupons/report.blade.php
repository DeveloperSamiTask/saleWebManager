                    ...
                    <div class="row gy-4 gy-sm-1">
                        <div class="col-sm-6 col-lg-3">
                            <div
                                ...
                                <div>
                                    <p class="mb-2">CUMPLEAÑOS</p>
                                    <h4 class="mb-2" id="birthday"></h4>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div
                                ...
                                <div>
                                    <p class="mb-2">NUMERO MAGICO</p>
                                    <h4 class="mb-2" id="nmagic"></h4>
...
@section('scripts')
    ...
    <script src="{{ asset('js/app-generate-list-partnes.js') }}"></script>
@endsection
