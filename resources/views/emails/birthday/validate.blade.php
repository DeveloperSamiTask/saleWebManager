...
<body id="body" class="t31" style="min-width:100%;Margin:0px;padding:0px;background-color:#F9F9F9;">
    <div class="t30" style="background-color:#F9F9F9;">
            ...
            <tr>
                <td class="t29"
                    ...
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr>
                            <td align="center">
                                <table class="t27" role="presentation" cellpadding="0" cellspacing="0"
                                    style="Margin-left:auto;Margin-right:auto;">
                                    <tr>
                                        <td width="400" class="t26" style="width:400px;">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="t1"><a
                                                                                                ...
                                                                                                target="_blank"><img
                                                                                                    ...
                                                                                                    height="100"
                                                                                                    alt=""
                                                                                                    src="https://i.postimg.cc/L5KNqgyP/cumpleanos.jpg" /></a>
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
                                                                            </td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="t7">
                                                                                            <h1 class="t6"
                                                                                                ...
                                                                                                Autorizar Pase Cumpleaños </h1>
                                                                                            <h1 class="t6"
                                                                                                style="margin:0;Margin:0;font-family:Inter,BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif;line-height:28px;font-weight:600;font-style:normal;font-size:24px;text-decoration:none;text-transform:none;letter-spacing:-1.2px;direction:ltr;color:#111111;te{{ $code }} </h1>
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td width="154" class="t21"
                                                                                ...
                                                                                <table class="t20"
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="t19"
                                                                                            style="overflow:hidden;background-color:#000;text-align:center;line-height:40px;mso-line-height-rule:exactly;mso-text-raise:8px;border-radius:8px 8px 8px 8px;">
                                                                                            <a class="t17"
                                                                                                href="{{ $url }}"
